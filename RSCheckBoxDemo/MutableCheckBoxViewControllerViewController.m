//
//  MutableCheckBoxViewControllerViewController.m
//  RSCheckBoxDemo
//
...
#import "MutableCheckBoxViewControllerViewController.h"
#import "ZZCheckBox.h"
@interface MutableCheckBoxViewControllerViewController ()<ZZCheckBoxDelegate, ZZCheckBoxDataSource, ZZCheckBoxStoryboardDataSource>
@property (nonatomic, strong) ZZCheckBox *mutableCheckBox;
...
@implementation MutableCheckBoxViewControllerViewController
...
- (void)viewDidLoad {
    ...
    _mutableCheckBox.tag = 1;
    _mutableCheckBox.delegate = self;
    _mutableCheckBox.dataSource = self;
    
    _storyboardCheckBox = [ZZCheckBox checkBoxWithCheckBoxType:CheckBoxTypeMutableCheckBox];
